...
class AllListAdapter(var obj: MainActivity, var list: ArrayList<HomeListsModel>) :
    RecyclerView.Adapter<AllListAdapter.MyHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyHolder {
        ...
        return AllListAdapter.MyHolder(itemView)
    }
